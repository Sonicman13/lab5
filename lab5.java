...
public class lab5 {
    public static void main(String[] args) {
        ...
        double price1;
        System.out.println("¬вести данные через read или init(1 - read, 2 - init)");
        f = in.nextLine();
        if(f.equals("1")){
            store[0] = new Store();
            store[0].read();
            ...
            System.out.println("¬вести все параметры (1), ввести только название (2), не вводить параметры (3)");
            f = in.nextLine();
            if(f.equals("1")){
                System.out.println("¬ведите название магазина");
                name1 = in.nextLine();
                System.out.println("¬ведите адрес магазина");
                adress1 = in.nextLine();
                System.out.println("ƒобавить игру(1 - да, 0 - нет)");
                f = in.nextLine();
                i = 0;
                while(f.equals("1")){
                    ...
                    System.out.println("¬ведите дату выхода(день, мес€ц(число), затем год(4 цифры), раздел€€ их нажатием Enter)");
                    release[0] = in.nextInt();
                    release[1] = in.nextInt();
                    release[2] = in.nextInt();
                    in.nextLine();
                    System.out.println("¬ведите платформы на которых доступна игра( чтобы закончить вводить платформы введите пустую строку)");
                    d = -1;
                    do
                    {
                        d++;
                ...
                numberOfGames1 = i;
                System.out.println("ƒобавить консоль(1 - да, 0 - нет)");
                f = in.nextLine();
                i = 0;
                while(f.equals("1")){
                    System.out.println("¬ведите название товара");
                    ...
                    in.nextLine();
                    System.out.println("¬ведите комплектацию( чтобы закончить вводить комплектацию введите пустую строку)");
                    d = -1;
                    do
                    {
                        d++;
                    ...
                    System.out.println("¬ведите платформы доступные по обратной совместимости( чтобы закончить вводить платформы введите пустую строку)");
                    d = -1;
                    do
                    {
                        d++;
        ...
        while(f.equals("10") == false){
            System.out.println("¬ведите номер следующего действи€");
            ...
            System.out.println("5 - ƒобавить магазин");
